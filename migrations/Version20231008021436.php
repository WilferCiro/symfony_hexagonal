 ...
 */
final class Version20231008021436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE products (id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE storage.buckets DROP CONSTRAINT buckets_owner_fkey');
        ...
        $this->addSql('ALTER TABLE storage.objects DROP CONSTRAINT objects_owner_fkey');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_1E52FDF3A76ED395 ON auth.mfa_factors (user_id)');
        $this->addSql('CREATE TABLE auth.identities (id TEXT NOT NULL, provider TEXT NOT NULL, user_id UUID NOT NULL, identity_data JSONB NOT NULL, last_sign_in_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, email TEXT DEFAULT \'email\', PRIMARY KEY(provider, id))');
        ...
        $this->addSql('CREATE TABLE storage.buckets (id TEXT NOT NULL, owner UUID DEFAULT NULL, name TEXT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT \'now()\', updated_at TIMESTAMP(0) WITH TIME ZONE DEFAULT \'now()\', public BOOLEAN DEFAULT false, avif_autodetection BOOLEAN DEFAULT false, file_size_limit BIGINT DEFAULT NULL, allowed_mime_types VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX bname ON storage.buckets (name)');
        $this->addSql('CREATE INDEX IDX_339A548CCF60E67C ON storage.buckets (owner)');
        $this->addSql('CREATE TABLE auth.saml_relay_states (id UUID NOT NULL, sso_provider_id UUID NOT NULL, request_id TEXT NOT NULL, for_email TEXT DEFAULT NULL, redirect_to TEXT DEFAULT NULL, from_ip_address VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE storage.objects (id UUID DEFAULT \'uuid_generate_v4()\' NOT NULL, bucket_id TEXT DEFAULT NULL, owner UUID DEFAULT NULL, name TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT \'now()\', updated_at TIMESTAMP(0) WITH TIME ZONE DEFAULT \'now()\', last_accessed_at TIMESTAMP(0) WITH TIME ZONE DEFAULT \'now()\', metadata JSONB DEFAULT NULL, path_tokens VARCHAR(255) DEFAULT \'/\', version TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE storage.buckets ADD CONSTRAINT buckets_owner_fkey FOREIGN KEY (owner) REFERENCES auth.users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE storage.objects ADD CONSTRAINT objects_owner_fkey FOREIGN KEY (owner) REFERENCES auth.users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
